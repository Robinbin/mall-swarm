...
public class OssServiceImpl implements OssService {
    ...
    public OssPolicyResult policy() {
        ...
        try {
            ...
            String callbackData = BinaryUtil.toBase64String(JSONUtil.parse(callback).toString().getBytes(UTF_8));
            // 返回结果
    ...
    public OssCallbackResult callback(HttpServletRequest request) {
        ...
        filename =
            "http://".concat(ALIYUN_OSS_BUCKET_NAME).concat(".").concat(ALIYUN_OSS_ENDPOINT).concat("/")
                .concat(filename);
